public class ZPiece extends Piece {
        ...
        public void findShadow() {
            ...
            if (this.orientation == 1) {
                int t1 = 0;
                int t2 = 1;
                if (piece[2].getY() > 1 && piece[3].getY() > 1 ) {
                    t1 = piece[2].getY();
                    t2 = piece[3].getY();
            ...
            if (this.orientation == 2) {
                ...
                int t2 = 1;
                int t3 = 1;
                if (piece[0].getY() > 1 && piece[2].getY() > 1 && piece[3].getY() > 1 ) {
                    t1 = piece[0].getY();
                    t2 = piece[2].getY();
                    t3 = piece[3].getY();
                    
                }
                while (t1 < 23 && t2 < 23 && t3 < 23 && board.getGridValue(piece[0].getX(), t1 + 1) == 0 && board.getGridValue(piece[2].getX(), t2 + 1) == 0 && 
